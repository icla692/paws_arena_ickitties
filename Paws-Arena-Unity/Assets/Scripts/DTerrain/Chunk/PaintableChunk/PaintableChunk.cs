...
namespace DTerrain
{
    ...
    public class PaintableChunk : MonoBehaviour, ITexturedChunk
    {
        ...
        public virtual void Init()
        {
            ...
            SpriteRenderer.sprite = Sprite.Create(TextureSource.Texture, new Rect(0, 0, TextureSource.Texture.width, TextureSource.Texture.height), Vector2.zero, TextureSource.PPU, 0, SpriteMeshType.FullRect);
        ...
        {
            if (at.x >= 0 && at.x < TextureSource.Texture.width &&
                at.y >= 0 && at.y < TextureSource.Texture.height)
        ...
        public virtual bool Paint(RectInt r, PaintingParameters pp)
        {
            ...
            //Setup this chunk ready to be updated on next Update();
            painted = true;
            return true;
        }
